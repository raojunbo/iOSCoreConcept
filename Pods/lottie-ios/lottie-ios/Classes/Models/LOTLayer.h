...
@property (nonatomic, readonly) LOTKeyframeGroup *rotation;             //旋转
@property (nonatomic, readonly, nullable) LOTKeyframeGroup *position;   //平移
...
@property (nonatomic, readonly) LOTKeyframeGroup *scale;//缩放
